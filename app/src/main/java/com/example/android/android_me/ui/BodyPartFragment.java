...
public class BodyPartFragment extends Fragment {
    private static final String TAG_BODY_PART_FRAGMENT = "body-part-fragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (mImageIds != null) imageView.setImageResource(mImageIds.get(mListIndex));
        else Log.e(TAG_BODY_PART_FRAGMENT, "List of image ids not found");
